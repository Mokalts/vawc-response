...
const CSS = `
    ...
    .mr-toolbar h1 { margin: 0; font-size: 17px; font-weight: 700; color: var(--adm-text); font-family: 'Lexend', sans-serif; }
    .mr-toolbar p { margin: 2px 0 0; font-size: 12.5px; color: var(--adm-text-muted); font-family: 'Lexend', sans-serif; }
    .mr-controls { display: flex; align-items: center; gap: 8px; flex-wrap: wrap; }
    .mr-select { padding: 9px 12px; border-radius: 8px; border: 1.5px solid var(--adm-border); background: var(--adm-card); color: var(--adm-text); font-size: 13px; font-family: 'Lexend', sans-serif; }
    .mr-btn {
    ...
    /* Gray stage so the white A4 sheet is clearly visible as a "page" */
    .mr-stage { background: #E2E8F0; border-radius: 10px; padding: 24px; overflow-x: auto; }

    .mr-paper {
        width: 11.69in;            /* A4 landscape width */
        min-height: 8.27in;        /* A4 landscape height */
        margin: 0 auto;
        background: #fff; color: #000;
        box-shadow: 0 4px 20px rgba(15,23,42,0.18);
        padding: 0.5in 0.55in; box-sizing: border-box;
    ...
    .mr-addrow { margin-top: 10px; padding: 7px 14px; border-radius: 7px; border: 1.5px dashed #B0B8C4; background: #fff; color: #475569; font-size: 12.5px; font-weight: 600; cursor: pointer; font-family: 'Lexend', sans-serif; }
    ...
    @media print {
        ...
        /* Isolate the sheet: hide everything (sidebar, topbar, toolbar), show only the paper */
        body * { visibility: hidden !important; }
        .mr-paper, .mr-paper * { visibility: visible !important; }
        .mr-paper {
        ...
        .mr-delcol, .mr-del, .mr-addrow { display: none !important; }
...
export default function MonthlyReport() {
    ...
    return (
        <AdminLayout breadcrumbs={["Monthly Report"]}>
            <style>{CSS}</style>

            <div className="mr-toolbar">
                <div>
                    <h1>Monthly Accomplishment Report</h1>
                    <p>Auto-filled from cases filed in the selected month. Every field is editable, correct anything before printing. What you see below is the actual A4 (landscape) page.</p>
                </div>
            ...
            {error && <div style={{ marginBottom: 16, background: "#FEF2F2", border: "1.5px solid #FECACA", borderRadius: 8, padding: "12px 16px", fontSize: 12.5, color: "#991B1B", fontFamily: "'Lexend',sans-serif" }}>{error}</div>}
