...
const CONTENT = {
    ...
    orders: {
        ...
        items: [
            ...
            { heading: 'No Mediation or Settlement at the Barangay', text: 'VAWC cases are NOT subject to mediation, conciliation, or amicable settlement at the barangay. Under the DILG-DSWD-DepEd-DOH-PCW Joint Memorandum Circular No. 2010-2, all forms of amicable settlement under the Katarungang Pambarangay do not apply to VAWC cases, and RA 9262 prohibits it. The barangay does not require you to "settle" or reconcile with the offender, and will not issue a Certificate to File Action or a Summons for mediation. Instead, the barangay issues a Barangay Protection Order, documents your case, and refers or endorses it to the PNP Women and Children Protection Desk, the C/MSWDO, or the court. You are never forced to face the offender.', highlight: true },
        ],
    },
    rights: {
